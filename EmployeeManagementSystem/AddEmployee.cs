...
namespace EmployeeManagementSystem
{
    ...
    {
        SqlConnection connect = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\EmployeeManagementSystem\EmployeeManagementSystem\employee.mdf;Integrated Security=True");
        ...
        private void addEmployee_addBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if(connect.State == ConnectionState.Closed)
                {
                    ...
                    {
                        connect.Open();
                        string checkEmID = "SELECT COUNT(*) FROM employees WHERE Emp_Id = '"+addEmployee_id.Text+"' AND delete_date IS NULL";
                           ...
                           // checkEm.Parameters.AddWithValue("@emID", addEmployee_id.Text.Trim());
                            ...
                            else
                            {
                                ...
                                string insertData = "INSERT INTO employees " +
                                    "(Emp_Id, full_name, gender, contact_number" +
                                   ...
                                   // "VALUES(@employeeID, @fullName, @gender, @contactNum" +
                                    ...
                                    "Values('"+addEmployee_id.Text+"','"+addEmployee_fullName.Text+"','"+addEmployee_gender.Text+"','"+addEmployee_phoneNum.Text+"'," +
                                    "'"+addEmployee_position.Text+ "',@image,@salary, @insertDate,'" + addEmployee_status.Text+"')";

                                string path = Path.Combine(@"C:\EmployeeManagementSystem\EmployeeManagementSystem\Directory\"
            ...
            else
            {
                ...
                if (check == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        string updateData = "UPDATE employees SET full_name = '"+addEmployee_fullName.Text+"'" +
                            ", gender ='"+addEmployee_gender.Text+"', contact_number = '"+addEmployee_phoneNum.Text+"'" +
                            ", position ='"+addEmployee_position.Text+"', update_date = @updateDate, status = '"+addEmployee_status.Text+"' " +
                            "WHERE Emp_Id ='"+addEmployee_id.Text+"'";
